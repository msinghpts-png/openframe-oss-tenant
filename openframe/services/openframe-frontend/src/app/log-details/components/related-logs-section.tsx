...
const DotIcon = () => (
  <div className="relative size-6">
    <div className="absolute inset-[37.5%] bg-[#888888] rounded-full" />
  </div>
)
...
const MeshCentralIcon = () => (
  <div className="relative size-4 bg-[#888888] rounded-[4px]" />
)

// Tactical RMM icon component (simplified placeholder)
const TacticalRMMIcon = () => (
  <div className="relative size-4 bg-[#888888] rounded-[2px]" />
)
  ...
  return (
    <div className="flex gap-2 items-start p-1 rounded-[6px] w-full relative">
      ...
      <div className="flex flex-col flex-1 justify-start min-w-0">
        <div className="font-['DM_Sans'] font-medium text-[14px] leading-[20px] text-[#fafafa] overflow-hidden text-ellipsis whitespace-nowrap min-w-full">
          {title}
        </div>
        <div className="flex gap-1 items-center">
          <div className="font-['Azeret_Mono'] font-medium text-[14px] leading-[20px] tracking-[-0.28px] uppercase text-[#888888] overflow-hidden text-ellipsis whitespace-nowrap">
            {timestamp}
          </div>
          {icon}
        </div>
      ...
      {!isLast && (
        <div className="absolute bg-[#3a3a3a] w-0.5 h-8 left-[15px] bottom-[-12px]" />
      )}
    </div>
  )
}
...
export function RelatedLogsSection() {
  ...
  return (
    <div className="flex flex-col gap-1 flex-1 min-w-0 self-stretch">
      ...
      {/* Related Logs Card */}
      <div className="bg-[#212121] border border-[#3a3a3a] rounded-[6px] flex-1 min-h-0 w-full">
